...
Although it is common to take more than five years to complete a PhD, it becomes necessary to find outside funding after the initial money runs out, which I understand as a primary means of discipline to keep moving folks through the system when we otherwise might be in no particular hurry.
...
Developing a more strict discipline of note-taking to remember where I learned of certain concepts is one method by which I can attempt to avoid perpetuating the marginalization of the knowledge produced by oppressed groups, whether by academics or not, groups I belong to or groups I am outside.
...
I barely even include hyperlinks even to documents I remember perfectly well the sources for, partly to avoid privilege certain sources of knowledge over others (especially written over verbal).
...
- Media studies: recent, less than 100 years old. Pretty much everything is mediated somehow, particularly for a researcher studying computers, so hopefully I can study as I see fit without too much interference.
